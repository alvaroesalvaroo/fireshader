...
void FireScene::Init() {
    ...
    // Ground material
    Material* groundMat = new Material(0.1f, 0.8f, 0.2f);
    ...
    Material* logsMat = new Material(0.1f, 0.6f, 0.f);
    mLogs->setMaterial(logsMat);

    Texture2D& logTex = ResourceManager::LoadTexture("log", "textures/logs.png");
    mLogs->setTextureId(logTex.ID);
    Texture2D& normalLogTex = ResourceManager::LoadTexture("normal", "textures/log-normal.jpg");
    mLogs->setSecondaryTextureId(normalLogTex.ID);
